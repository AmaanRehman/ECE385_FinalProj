...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../FinalProj.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../finalprojsoc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is finalprojsoc
SOPC_NAME := finalprojsoc
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1682376367
SOPC_SYSID_FLAG += --timestamp=1682376367
ELF_PATCH_FLAG  += --timestamp 1682376367
